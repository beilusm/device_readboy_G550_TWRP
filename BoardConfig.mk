...
DEVICE_PATH := device/readboy/G550
...
TARGET_KERNEL_CONFIG := G550_defconfig
TARGET_KERNEL_SOURCE := kernel/readboy/G550
...
BOARD_BOOTIMAGE_PARTITION_SIZE := 9999999999999999
...
TW_DEVICE_VERSION := $(shell date -u +"%Y%m%d"-"by-beilusm")
